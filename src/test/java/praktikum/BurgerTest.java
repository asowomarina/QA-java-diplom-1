...
//        Mockito.when(bun.getPrice()).thenReturn(199.9f);
//        burger.setBuns(bun);
//
//        Mockito.when(ingredient.getType()).thenReturn(IngredientType.SAUCE);
//        Mockito.when(ingredient.getName()).thenReturn("chili");
//        Mockito.when(ingredient.getPrice()).thenReturn(19.9f);
//        burger.addIngredient(ingredient);
//
...
public class BurgerTest {
    ...
    public void getReceipt() {
        ...
        assertEquals("Некорректный чек бургера", expected, actual);
    }

    private void appendIngredients(StringBuilder receipt) {
